...
--- @class CIJob GitHub Actions check-run summary (one matrix-expanded job at PR head-commit).
...
--- @field name string "workflow: job-name" (e.g. "CI: build (ubuntu)"), or just the job-name if no workflow.
